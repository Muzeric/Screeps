...
var queue = {
    ...
    addRequest: function (from, to, resourceType, amount) {
        ...
        */
        ...
        this.transportReserved[req_to.id] = this.transportReserved[req_to.id] || {};
        this.transportReserved[req_to.id][req_resourceType] = (this.transportReserved[req_to.id][req_resourceType] || 0) + req_amount;
    ...
    gotResource: function (reqID, amount) {
        ...
        this.carring[request.toRoomName][request.resourceType] = (this.carring[request.toRoomName][request.resourceType] || 0) + amount;
